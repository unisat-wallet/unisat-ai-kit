...
- Finalize the repository skeleton and command naming
- Define input/output schemas for the first capability set
- Integrate the first knowledge sources: docs, OpenAPI, error catalogs, and SDK guidance
- Ship a minimal `doctor` flow and capability inventory
